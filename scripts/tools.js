...
const tenant_enum = {
  ...
  MERCHANT_PRODUCT: "Payments solution area",
  FI_PRODUCT: "Banking solution area",
  FINTECH_PRODUCT: "Fintech solution area",
  CARAT_PRODUCT: "Product of Carat",
  MERCHANT_AREA: "Merchants solution area",
  CUSTOMER_SEGMENTS_FOR_MERCHANTS: "Customer Segments for Payments",
  CAPABILITIES_FOR_MERCHANTS: "Capabilities for Payments",
  FINANCIAL_INSTITUTIONS_SOLUTION_AREA: "Banking solution area",
  CUSTOMER_SEGMENTS_FOR_FINANCIAL_INSTITUTIONS: "Customer Segments for Banking",
